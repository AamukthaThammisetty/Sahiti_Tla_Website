...
leftBtnn.addEventListener('mouseenter', moveLeft);
leftBtnn.addEventListener('mouseleave', stopMovement);
rightBtnn.addEventListener('mouseenter', moveRight);
rightBtnn.addEventListener('mouseleave', stopMovement);
